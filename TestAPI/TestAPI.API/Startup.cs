...
using TestAPI.API.Common.Attributes;
using TestAPI.API.Common.Middlewares;
using TestAPI.API.Common.Settings;
using TestAPI.API.Swagger;
using TestAPI.IoC.Configuration.DI;
using Repositories;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            try
            {
                if (_appSettings.IsValid())
                {
                    ...
                    //Redis
                    services.Configure<Repositories.Redis.RedisConfiguration>(Configuration.GetSection("Redis"));

                    //services.AddStackExchangeRedisCache(options => {
                    //    options.Configuration = Configuration.GetConnectionString("RedisConnection");
                    //    options.InstanceName = "rediswfirewall";
                    //});
